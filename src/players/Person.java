...
/**
 * Person class represents a player in the game
 * @author Kellyn, Joey, Tyler, & Patrick
 * @throws InvalidArgumentException If a player wants to offer more resource cards than he has in his hand
...
public class Person {
     ...
     * @param playerColor
     */
	public Person(String name, playerColors playerColor){
	    this.name = name;
     ...
     * @throws InvalidArgumentException if any quantities cannot be fullfilled. ie) Hand has 1 wheat, but 2 wheat are
     * being offered.
     */
    public ArrayList<ResourceType> buildOffering(int qtyWheat,int qtyWool,int qtyOre,int qtyLumber, int qtyBrick) throws InvalidArgumentException{
        ...
        if(checkOfferValid(qtyWheat,ResourceType.WHEAT,copiedHand)){
            ...
            throw new InvalidArgumentException(new String[]{"Player does not have enough resources."});
        }
