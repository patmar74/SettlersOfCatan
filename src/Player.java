 ...
 *             If a player wants to offer more resource cards than he has in his
 *             hand ie) Player has 1 wheat, but wants to offer 2 wheat
 */
public class Player {
	...
	/**
	 * Constructor gives a player name, player color, and initializes 4 player
	 * settlements, and 15 roads
	 * 
	 * @param name
	 * @param playerColor
	 */
	...
	/**
	 * Gets a deep copy of the player's hand. This makes sure that the hand is
	 * not changed due incidentally
	 * 
	...
	/**
	 * Makes a "hand" of all the resources that the player wants to offer as a
	 * trade
	 * 
	 * @param qtyWheat
	 *            Quantity of wheat being offered
	 * @param qtyWool
	 *            Quantity of wool being offered
	 * @param qtyOre
	 *            Quantity of ore being offered
	 * @param qtyLumber
	 *            Quantity of lumber being offered
	 * @param qtyBrick
	 *            Quantity of brick being offered
	 * @return ArrayList<ResourceType> All resources the player wants to offer
	 *         as a trade
	 * @throws IllegalArgumentException
	 *             if any quantities cannot be fullfilled. ie) Hand has 1 wheat,
	 *             but 2 wheat are being offered.
	 */
	public ArrayList<ResourceType> buildOffering(int qtyWheat, int qtyWool, int qtyOre, int qtyLumber, int qtyBrick)
			throws IllegalArgumentException {
	...
	/**
	 * Checks if enough resources are available to add the resource to the
	 * offering This is useful to check if the buildOffering should throw an
	 * exception
	 * 
	 * @param qty
	 *            int Quantity of resource wanted
	 * @param resource
	 *            ResourceType Resource method
	 * @param copy
	 *            ArrayList<ResourceType> A deep copy of the player's hand
	...
	private boolean checkOfferValid(int qty, ResourceType resource, ArrayList<ResourceType> copy) {
		int qtyAvailable = 0;
		// Loop through copy of hand and increment qtyAvailable if resource
		// matched the current resource type
	...
	/**
	 * Get the number of a specific resource in the player's hand. This is
	 * useful to the GUI so that the values can be updated.
	 * 
	 * @param resource
	 *            ResourceType The resource type that is being totaled
	 * @return int The number of resource cards in the player's hand that are of
	 *         selected type.
	 */
